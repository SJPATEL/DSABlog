...
if(isset($_GET['delete'])){
    $id = $obj->get_safe_str($_GET['delete']);

    $delete = $obj->deleteData('students',"id=$id");
    if($delete){
                ...
                if (isset($result[0])) {
                    ...
                    foreach ($result as $row) { ?>
                        ...
                        <tr>
                            ...
                            <th><a href="?delete=<?php echo $row['id']; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
