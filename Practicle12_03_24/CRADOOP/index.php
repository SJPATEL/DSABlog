...
if(isset($_POST['addStudent'])){
  ...
  $obj = new query(); // declare class object
    ...
    $result = $obj->insertData('students','name,email,contact,course',"'$name','$email','$contact','$course'");
    if($result){
  ...
  <div class="col-md-6 m-auto my-2">
    <form action="" method="post">
      ...
      <div class="mb-3">
        ...
        <input type="number" class="form-control" id="exampleInputPassword1" name="contact" placeholder="Enter your contact">
      </div>
      <div class="mb-3">
        <label for="exampleInputPassword1" class="form-label">Course</label>
        <input type="text" class="form-control" id="exampleInputPassword1" name="course" placeholder="Enter your course">
      </div>

      <button type="submit" class="btn btn-danger py-2 col-md-2" name="addStudent">Add</button>
    </form>
  </div>
